...
const ThoughtSkeleton = () => (
  ...
  >
    ...
    <div className="flex flex-col max-w-xs space-y-2">
      <motion.div
        animate={{ 
          backgroundColor: ['rgba(156, 163, 175, 0.2)', 'rgba(156, 163, 175, 0.4)', 'rgba(156, 163, 175, 0.2)']
        }}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <motion.p
              animate={{ 
                background: [
                  'linear-gradient(90deg, rgba(156, 163, 175, 0.1) 0%, rgba(156, 163, 175, 0.2) 50%, rgba(156, 163, 175, 0.1) 100%)',
                  'linear-gradient(90deg, rgba(156, 163, 175, 0.2) 0%, rgba(156, 163, 175, 0.3) 50%, rgba(156, 163, 175, 0.2) 100%)',
                  'linear-gradient(90deg, rgba(156, 163, 175, 0.1) 0%, rgba(156, 163, 175, 0.2) 50%, rgba(156, 163, 175, 0.1) 100%)'
                ]
              }}
              transition={{ duration: 2, repeat: Infinity }}
              className="text-sm whitespace-pre-wrap text-gray-500 font-medium px-3 py-2 rounded-lg bg-gray-100/50 backdrop-blur-sm border border-gray-200/50"
            >
              {thought.content}
            </motion.p>
